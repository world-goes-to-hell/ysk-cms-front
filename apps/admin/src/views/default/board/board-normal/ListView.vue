    ...
    <div v-if="selectedBoardCode" v-loading="isLoading" class="posts-container">
      <div v-if="posts.length > 0" class="posts-table">
        ...
        >
          <!-- 게시글 정보 -->
          <div class="col-info">
            <div class="post-icon" :class="{ 'is-pinned': post.isPinned, 'is-secret': post.isSecret }">
              <i v-if="post.isPinned" class="mdi mdi-pin"></i>
              <i v-else-if="post.isSecret" class="mdi mdi-lock-outline"></i>
      ...
      <div v-if="currentPost" class="post-detail">
        <div class="post-detail-header">
          <div class="detail-badges">
            ...
            <span v-if="currentPost.isSecret" class="badge secret">
              <i class="mdi mdi-lock-outline"></i> 비밀글
            </span>
