    ...
    <div v-if="selectedBoardCode" class="stats-row">
      <div class="stat-card">
        ...
        <div class="stat-info">
          ...
          <span class="stat-label">전체 Q&A</span>
        </div>
      </div>
      <div class="stat-card">
        ...
        <div class="stat-info">
          <span class="stat-value">{{ posts.filter(p => p.hasAnswer).length }}</span>
      ...
      <div v-if="posts.length > 0" class="posts-table">
        ...
        >
          ...
          <div class="col-answer">
            <span class="answer-badge" :class="post.hasAnswer ? 'answered' : 'waiting'">
              <i class="mdi" :class="post.hasAnswer ? 'mdi-check' : 'mdi-clock-outline'"></i>
              {{ post.hasAnswer ? '답변 완료' : '답변 대기' }}
            </span>
          </div>
...
.table-row.waiting-answer {
  border-left: 3px solid #f59e0b;
}

.table-row.has-answer {
